...
// frame. Screen-recording drifts (an earlier story came out 3.2x slow);
...
const DIR = `${SC}/_americano_frames`;
...
await p.goto('file://' + SC + '/americano-story.html', { waitUntil: 'load' });
